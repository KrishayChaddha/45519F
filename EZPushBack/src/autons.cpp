...
void sawp_autonfail() {
  ...
  intake.move(127);
  chassis.pid_turn_set(-216_deg, TURN_SPEED);
  chassis.pid_wait();
  ...
  intake.move(127);
  chassis.pid_drive_set(45_in, 90);
  chassis.pid_wait();
  intake.move(0);
...
void right_side() {
  ...
  chassis.pid_drive_set(5.2_in, 100);
  chassis.pid_wait();
  ...
  intake.move(127);
  chassis.pid_drive_set(15.9_in, 127);
  chassis.pid_wait();
  matchload.set(true);
  pros::delay(150);

  chassis.pid_drive_set(13.1_in, 100);
  chassis.pid_wait();
  intake.move(0);
  matchload.set(false);
  ...
  chassis.pid_drive_set(13.2_in, 100);
  chassis.pid_wait();
  pros::delay(135);
